...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  * Если на экране только одно редактируемое значение - то его изменение осуществляется при помощи вращения энкодера, или вводом с клавиатуры. 
    Кнопка "< НАЗАД" на таком экране - всегда подсвечена, и переход на предыдущий экран осуществляется кликом кнопки энкодера;

  * Если на экране есть несколько редактируемых полей, то активное редактируемое поле - подсвечивается, и ввод доступен именно в него. 
