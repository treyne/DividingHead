...
#define ENCODER_B_PIN       A2 // пин вывода В энкодера
#define ENCODER_BUTTON_PIN  A3 // пин вывода кнопки энкодера
#define ENCODER_PPC         6 // количество импульсов на клик, подбирать для удобства
...
#define EN_PIN_ON_LEVEL         LOW // уровень для ВКЛЮЧЕНИЯ драйвера шагового (вывод ENABLE драйвера)
...
#define MAX_SPEED               2 // оборотов в минуту
#define STEP_PULSE_WIDTH        50 // ширина импульса STEP, микросекунд (зависит от используемого драйвера)
